...
const DrainMap: React.FC<DrainMapProps> = ({
    ...
    const fetchAllStretches = async () => {
        try {
            ...
            const response = await fetch('/basics/all-stretches/');
    ...
    return (
        <div className={`map-container ${className || ''}`} style={{ background: 'rgb(255, 255, 255)' }}>
            <div className="relative">
                    ...
                    <div className="flex flex-wrap gap-4 mb-2 items-center">
                        ...
                        <div>
                            {selectedDrains.length > 0 && (
                                <div className="absolute top-2 right-2 mt-19 flex flex-col gap-1 z-[1000]">
                ...
                <div
                    ref={mapContainerRef}
                    className="drain-map border-4 border-blue-500 rounded-xl shadow-lg p-0 hover:border-green-500 hover:shadow-2xl transition-all duration-300 w-[40vw] h-[49vh] mx-auto"
